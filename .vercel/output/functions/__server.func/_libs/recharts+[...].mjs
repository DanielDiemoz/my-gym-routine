...
import { C as require_isFunction, S as require_memoize, _ as require_isNumber, a as require_find, b as require_sortBy, c as require_upperFirst, d as require_max, f as require_last, g as require_isNaN, h as require_uniqBy, i as require_every, l as require_flatMap, m as require_throttle, n as require_range, o as require_isBoolean, p as require_isEqual, r as require_mapValues, s as require_isPlainObject, t as require_some, u as require_min, v as require_isString, w as require_isObject, x as require_get, y as require_isNil } from "./lodash.mjs";
	...
	return _createClass$15(Tooltip, [{
		...
		value: function render() {
			...
			return /*#__PURE__*/ import_react.createElement(TooltipBoundingBox, {
				...
				viewBox,
				wrapperStyle
			}, renderContent$1(content, _objectSpread$28(_objectSpread$28({}, this.props), {}, { payload: finalPayload })));
		}
	}]);
}(import_react.PureComponent);
...
var DecimalCSS = /*#__PURE__*/ function() {
	...
	return _createClass$13(DecimalCSS, [
		...
		value: function parse(str) {
			...
			var _ref2 = _slicedToArray$6((_NUM_SPLIT_REGEX$exec = NUM_SPLIT_REGEX.exec(str)) !== null && _NUM_SPLIT_REGEX$exec !== void 0 ? _NUM_SPLIT_REGEX$exec : [], 3), numStr = _ref2[1], unit = _ref2[2];
...
function calculateArithmetic(expr) {
	...
	while (newExpr.includes("*") || newExpr.includes("/")) {
		...
		var _ref4 = _slicedToArray$6((_MULTIPLY_OR_DIVIDE_R = MULTIPLY_OR_DIVIDE_REGEX.exec(newExpr)) !== null && _MULTIPLY_OR_DIVIDE_R !== void 0 ? _MULTIPLY_OR_DIVIDE_R : [], 4), leftOperand = _ref4[1], operator = _ref4[2], rightOperand = _ref4[3];
	...
	while (newExpr.includes("+") || /.-\d+(?:\.\d+)?/.test(newExpr)) {
		...
		var _ref6 = _slicedToArray$6((_ADD_OR_SUBTRACT_REGE = ADD_OR_SUBTRACT_REGEX.exec(newExpr)) !== null && _ADD_OR_SUBTRACT_REGE !== void 0 ? _ADD_OR_SUBTRACT_REGE : [], 4), _leftOperand = _ref6[1], _operator = _ref6[2], _rightOperand = _ref6[3];
...
function calculateParentheses(expr) {
	...
	while (newExpr.includes("(")) {
		var parentheticalExpression = _slicedToArray$6(PARENTHESES_REGEX.exec(newExpr), 2)[1];
...
var calculateWordsByLines = function calculateWordsByLines(_ref2, initialWordsWithComputedWith, spaceWidth, lineWidth, scaleToFit) {
	...
	while (start <= end && iterations <= text.length - 1) {
		...
		var _checkOverflow2 = _slicedToArray$5(checkOverflow(middle - 1), 2), doesPrevOverflow = _checkOverflow2[0], result = _checkOverflow2[1];
		var doesMiddleOverflow = _slicedToArray$5(checkOverflow(middle), 1)[0];
...
function getValidInterval(_ref) {
	var _ref2 = _slicedToArray$4(_ref, 2), min = _ref2[0], max = _ref2[1];
...
function getNiceTickValuesFn(_ref3) {
	var _ref4 = _slicedToArray$4(_ref3, 2), min = _ref4[0], max = _ref4[1];
	var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
	var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
	var count = Math.max(tickCount, 2);
	var _getValidInterval2 = _slicedToArray$4(getValidInterval([min, max]), 2), cormin = _getValidInterval2[0], cormax = _getValidInterval2[1];
...
function getTickValuesFixedDomainFn(_ref7, tickCount) {
	var _ref8 = _slicedToArray$4(_ref7, 2), min = _ref8[0], max = _ref8[1];
	var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
	var _getValidInterval6 = _slicedToArray$4(getValidInterval([min, max]), 2), cormin = _getValidInterval6[0], cormax = _getValidInterval6[1];
...
function Surface(props) {
	var children = props.children, width = props.width, height = props.height, viewBox = props.viewBox, className = props.className, style = props.style, title = props.title, desc = props.desc, others = _objectWithoutProperties$10(props, _excluded$10);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
	...
	return /*#__PURE__*/ import_react.createElement("svg", _extends$20({}, filterProps(others, true, "svg"), {
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$25(_objectSpread$25({}, _objectWithoutProperties$9(_ref, _excluded$9)), {}, {
		type,
		size,
		sizeType
	});
	...
	*/
	...
	if (cx === +cx && cy === +cy && size === +size) return /*#__PURE__*/ import_react.createElement("path", _extends$19({}, filteredProps, {
	...
	return _createClass$12(DefaultLegendContent, [
		{
			...
			value: function renderIcon(data) {
				...
				if (/*#__PURE__*/ import_react.isValidElement(data.legendIcon)) {
					var iconProps = _objectSpread$24({}, data);
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					return /*#__PURE__*/ import_react.createElement("li", _extends$18({
						className,
						style: itemStyle,
...
function renderContent(content, props) {
	...
	if (typeof content === "function") return /*#__PURE__*/ import_react.createElement(content, props);
	props.ref;
	var otherProps = _objectWithoutProperties$8(props, _excluded$8);
...
var Legend = /*#__PURE__*/ function(_PureComponent) {
	function Legend() {
		var _this;
		_classCallCheck$11(this, Legend);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
	...
	return _createClass$11(Legend, [
		...
		},
		{
			...
			value: function getBBoxSnapshot() {
				if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0) return _objectSpread$23({}, this.lastBoundingBox);
				return {
					width: 0,
					height: 0
				};
		...
		},
		{
			...
			value: function getDefaultPosition(style) {
				...
				return _objectSpread$23(_objectSpread$23({}, hPos), vPos);
			}
		},
		{
			key: "render",
			value: function render() {
				...
				var outerStyle = _objectSpread$23(_objectSpread$23({
					position: "absolute",
					width: width || "auto",
					height: height || "auto"
				...
				}, renderContent(content, _objectSpread$23(_objectSpread$23({}, this.props), {}, { payload: getUniqPayload(payload, payloadUniqBy, defaultUniqBy) })));
			}
		}
	], [{
		key: "getWithHeight",
		value: function getWithHeight(item, chartWidth) {
			var layout = _objectSpread$23(_objectSpread$23({}, this.defaultProps), item.props).layout;
...
var _excluded$6 = ["valueAccessor"], _excluded2$2 = [
	"data",
	"dataKey",
	"clockWise",
	"id",
...
var Sector = function Sector(sectorProps) {
	var props = _objectSpread$15(_objectSpread$15({}, defaultProps), sectorProps);
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		return _objectSpread$11(_objectSpread$11({}, result), {}, _defineProperty$14({}, id, finalAxis));
	}, {});
};
...
var createLabeledScales = function createLabeledScales(options) {
	var scales = Object.keys(options).reduce(function(res, key) {
		return _objectSpread$11(_objectSpread$11({}, res), {}, _defineProperty$14({}, key, ScaleHelper.create(options[key])));
	}, {});
	...
	return _createClass$8(CartesianAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$9(_objectSpread$9(_objectSpread$9({}, filterProps(this.props, false)), filterProps(axisLine, false)), {}, { fill: "none" });
				...
				return /*#__PURE__*/ import_react.createElement("line", _extends$10({}, props, { className: clsx("recharts-cartesian-axis-line", (0, import_get.default)(axisLine, "className")) }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks(ticks, fontSize, letterSpacing) {
				...
				var finalTicks = getTicks(_objectSpread$9(_objectSpread$9({}, this.props), {}, { ticks }), fontSize, letterSpacing);
				...
				var items = finalTicks.map(function(entry, i) {
					...
					}, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$10({}, tickLineProps, lineCoord, { className: clsx("recharts-cartesian-axis-tick-line", (0, import_get.default)(tickLine, "className")) })), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat((0, import_isFunction.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || "")));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			if (/*#__PURE__*/ import_react.isValidElement(option)) tickItem = /*#__PURE__*/ import_react.cloneElement(option, _objectSpread$9(_objectSpread$9({}, props), {}, { className: combinedClassName }));
			else if ((0, import_isFunction.default)(option)) tickItem = option(_objectSpread$9(_objectSpread$9({}, props), {}, { className: combinedClassName }));
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$10({}, props, { className: "recharts-cartesian-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.Component);
_defineProperty$12(CartesianAxis, "displayName", "CartesianAxis");
_defineProperty$12(CartesianAxis, "defaultProps", {
	x: 0,
	y: 0,
	width: 0,
	height: 0,
